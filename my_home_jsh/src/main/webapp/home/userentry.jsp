...
<body>
	...
	<form:form action="../entry/entry.html" modelAttribute="user"
		method="post" name="frm" onSubmit="return formCheck(this)">
...
아이디: <form:input path="user_id" />
		...
		<br />
패스워드: <form:password path="password" />
		<br />
패스워드 확인: <input type="password" name="CONFIRM" />
		<br />
성별: 남<form:radiobutton path="gender" value="M" />
여<form:radiobutton path="gender" value="F" />
		<br />
		<br />
메일: <form:input path="email" />
		<br />
